...
// EEPROM map information is duplicated in
// common_const.h for the
...
mboard_eeprom_t e200_impl::get_mb_eeprom(uhd::i2c_iface::sptr iface)
{
...
void e200_impl::set_mb_eeprom(const mboard_eeprom_t& mb_eeprom)
{
