...
#include "E200_iface.hpp"
#include "E200_uart.hpp"
...
static const uint16_t E200_FPGA_COMPAT_NUM    = 16;
static const uint16_t E205_FPGA_COMPAT_NUM    = 7;
static const double E200_BUS_CLOCK_RATE       = 100e6;
static const uint32_t E200_GPSDO_ST_NONE      = 0x83;
static constexpr double E200_MAX_RATE_USB2    = 53248000; // bytes/s
static constexpr double E200_MAX_RATE_USB3    = 500000000; // bytes/s

#define FLIP_SID(sid) (((sid) << 16) | ((sid) >> 16))

static const uint32_t E200_CTRL0_MSG_SID = 0x00000010;
static const uint32_t E200_RESP0_MSG_SID = FLIP_SID(E200_CTRL0_MSG_SID);

static const uint32_t E200_CTRL1_MSG_SID = 0x00000020;
static const uint32_t E200_RESP1_MSG_SID = FLIP_SID(E200_CTRL1_MSG_SID);

static const uint32_t E200_TX_DATA0_SID = 0x00000050;
static const uint32_t E200_TX_MSG0_SID  = FLIP_SID(E200_TX_DATA0_SID);

static const uint32_t E200_TX_DATA1_SID = 0x00000060;
static const uint32_t E200_TX_MSG1_SID  = FLIP_SID(E200_TX_DATA1_SID);

static const uint32_t E200_RX_DATA0_SID = 0x000000A0;
static const uint32_t E200_RX_DATA1_SID = 0x000000B0;

static const uint32_t E200_TX_GPS_UART_SID = 0x00000030;
static const uint32_t E200_RX_GPS_UART_SID = FLIP_SID(E200_TX_GPS_UART_SID);

static const uint32_t E200_LOCAL_CTRL_SID = 0x00000040;
static const uint32_t E200_LOCAL_RESP_SID = FLIP_SID(E200_LOCAL_CTRL_SID);

static const unsigned char E200_USB_CTRL_RECV_INTERFACE = 4;
static const unsigned char E200_USB_CTRL_RECV_ENDPOINT  = 8;
static const unsigned char E200_USB_CTRL_SEND_INTERFACE = 3;
static const unsigned char E200_USB_CTRL_SEND_ENDPOINT  = 4;

static const unsigned char E200_USB_DATA_RECV_INTERFACE = 2;
static const unsigned char E200_USB_DATA_RECV_ENDPOINT  = 6;
static const unsigned char E200_USB_DATA_SEND_INTERFACE = 1;
static const unsigned char E200_USB_DATA_SEND_ENDPOINT  = 2;

// Default recv_frame_size. Must not be a multiple of 512.
static const int E200_USB_DATA_DEFAULT_FRAME_SIZE = 8176;
// recv_frame_size values below this will be upped to this value
static const int E200_USB_DATA_MIN_RECV_FRAME_SIZE = 40;
static const int E200_USB_DATA_MAX_RECV_FRAME_SIZE = 16360;
...
static std::vector<uhd::transport::usb_device_handle::vid_pid_pair_t> b200_vid_pid_pairs =
    boost::assign::list_of(uhd::transport::usb_device_handle::vid_pid_pair_t(
        E200_VENDOR_ID, E200_PRODUCT_ID))(
        uhd::transport::usb_device_handle::vid_pid_pair_t(
            E200_VENDOR_ID, E200MINI_PRODUCT_ID))(
        uhd::transport::usb_device_handle::vid_pid_pair_t(
            E200_VENDOR_ID, E205MINI_PRODUCT_ID))(
        uhd::transport::usb_device_handle::vid_pid_pair_t(
            E200_VENDOR_NI_ID, E200_PRODUCT_NI_ID))(
        uhd::transport::usb_device_handle::vid_pid_pair_t(
            E200_VENDOR_NI_ID, E210_PRODUCT_NI_ID));

e200_product_t get_e200_product(const uhd::transport::usb_device_handle::sptr& handle,
    const uhd::usrp::mboard_eeprom_t& mb_eeprom);
std::vector<uhd::transport::usb_device_handle::sptr> get_e200_device_handles(
