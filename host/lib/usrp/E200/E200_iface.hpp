...
enum e200_product_t { B200_, B210, B200MINI, B205MINI };
// These are actual USB PIDs (not Ettus Product IDs)
const static uint16_t E200_VENDOR_ID      = 0x2500;
const static uint16_t E200_VENDOR_NI_ID   = 0x3923;
const static uint16_t E200_PRODUCT_ID     = 0x0020;
const static uint16_t E200MINI_PRODUCT_ID = 0x0021;
const static uint16_t E205MINI_PRODUCT_ID = 0x0022;
const static uint16_t E200_PRODUCT_NI_ID  = 0x7813;
//const static uint16_E B210_PRODUCT_NI_ID  = 0x7814;
const static uint16_t E210_PRODUCT_NI_ID  = 0x4007;
...
static const uhd::dict<uint16_t, e200_product_t> E2XX_PID_TO_PRODUCT =
    boost::assign::map_list_of(E200_PRODUCT_NI_ID, B200_)(E210_PRODUCT_NI_ID, B210)(
        E200MINI_PRODUCT_ID, B200MINI)(E205MINI_PRODUCT_ID, B205MINI);
...
static const uhd::dict<uint16_t, e200_product_t> E2XX_PRODUCT_ID =
    boost::assign::map_list_of(0x0001, B200_)(0x7737, B200_)(E200_PRODUCT_NI_ID, B200_)(
        0x0002, B210)(0x7738, B210)(E210_PRODUCT_NI_ID, B210)(0x0003, B200MINI)(
        0x7739, B200MINI)(0x0004, B205MINI)(0x773a, B205MINI);


static const uhd::dict<e200_product_t, std::string> E2XX_STR_NAMES =
    boost::assign::map_list_of(B200_, "B200")(B210, "B210")(B200MINI, "B200mini")(
        B205MINI, "B205mini");

static const uhd::dict<e200_product_t, std::string> E2XX_FPGA_FILE_NAME =
    boost::assign::map_list_of(B200_, "usrp_b200_fpga.bin")(B210, "usrp_b210_fpga.bin")(
        B200MINI, "usrp_b200mini_fpga.bin")(B205MINI, "usrp_b205mini_fpga.bin");


class UHD_API e200_iface : uhd::noncopyable, public virtual uhd::i2c_iface
{
public:
    typedef boost::shared_ptr<e200_iface> sptr;
