...
const static uint16_t B210_PRODUCT_NI_ID  = 0x4007;
...
static const uhd::dict<uint16_t, b200_product_t> B2XX_PID_TO_PRODUCT =
    boost::assign::map_list_of(B200_PRODUCT_NI_ID, B200_)(B210_PRODUCT_NI_ID, B210)(
...
static const uhd::dict<uint16_t, b200_product_t> B2XX_PRODUCT_ID =
    boost::assign::map_list_of(0x0001, B200_)(0x7737, B200_)(B200_PRODUCT_NI_ID, B200_)(
