...
create_project antsdr_t310 ./antsdr_t310 -part xc7z100ffg900-2
...
set_property verilog_define SFP_10GBE=1 [current_fileset]

# create the block design
source ./bd/t310_ps_bd.tcl

# make hdl wrapper for block design
make_wrapper -files [get_files ./bd/t310_ps_bd/t310_ps_bd.bd] -top
add_files -norecurse ./bd/t310_ps_bd/hdl/t310_ps_bd_wrapper.v

# create the block design
source ./bd/pl_dram_buffer.tcl 

# make hdl wrapper for block design
make_wrapper -files [get_files ./bd/pl_dram_buffer/pl_dram_buffer.bd] -top
add_files -norecurse ./bd/pl_dram_buffer/hdl/pl_dram_buffer_wrapper.v

# add files to this project
add_files {
    ./ip/fifo_4k_2clk/fifo_4k_2clk.xci
    ./ip/fifo_short_2clk/fifo_short_2clk.xci
    ./ip/axi_eth_dma/axi_eth_dma.xci
    ...
    ./top/n3xx_sfp_wrapper.v
    ./top/async_fifo/async_fifo.v
    ./top/async_fifo/fifomem.v
    ./top/async_fifo/rptr_empty.v
    ./top/async_fifo/sync_r2w.v
    ./top/async_fifo/sync_w2r.v
    ./top/async_fifo/wptr_full.v

    ../lib/ngc/hbdec2.ngc
    ../lib/ngc/hbdec1.ngc
    ../lib/dsp/acc.v
    ../lib/cat_io/ad9361_lvds.v
    ../lib/cat_io/ad9361_lvds_rx.v
    ../lib/cat_io/ad9361_lvds_tx.v
    ../lib/dsp/add2.v
    ...
    ../lib/one_gige_phy/one_gig_eth_pcs_pma_gt_common.v
    ../lib/one_gige_phy/one_gig_eth_pcs_pma_resets.v
    ../lib/one_gige_phy/one_gig_eth_pcs_pma_support.v
    ./ip/one_gig_eth_pcs_pma/one_gige_phy.v

    ../lib/control/por_gen.v
    ...
    ../lib/xge/rtl/verilog/ten_gig_eth_pcs_pma_gt_common.v
...
# add constrain file
add_files -fileset constrs_1 -norecurse ./xdc/mb_pins.xdc
...
file mkdir ./antsdr_t310/antsdr_t310.sdk
file copy -force ./antsdr_t310/antsdr_t310.runs/impl_1/antsdr_t310.sysdef ./antsdr_t310/antsdr_t310.sdk/system_top.hdf
