...
create_generated_clock -name CAT_FBCLK_P -source [get_pins u_antsdr_e310v2_io/oddr_clk/C] -multiply_by 1 [get_ports CAT_FBCLK_P]



set_input_delay -clock [get_clocks CAT_DCLK_P] -max 5.700 [get_ports {CAT_P0_D* CAT_RX_FR_P}]
set_input_delay -clock [get_clocks CAT_DCLK_P] -min 4.500 [get_ports {CAT_P0_D* CAT_RX_FR_P}]
set_input_delay -clock [get_clocks CAT_DCLK_P] -clock_fall -max -add_delay 5.700 [get_ports {CAT_P0_D* CAT_RX_FR_P}]
set_input_delay -clock [get_clocks CAT_DCLK_P] -clock_fall -min -add_delay 4.500 [get_ports {CAT_P0_D* CAT_RX_FR_P}]


set_output_delay -clock CAT_FBCLK_P -max 5.500 [get_ports {CAT_P1_D* CAT_TX_FR_P}]
set_output_delay -clock CAT_FBCLK_P -min 4.500 [get_ports {CAT_P1_D* CAT_TX_FR_P}]
set_output_delay -clock CAT_FBCLK_P -clock_fall -max -add_delay 5.500 [get_ports {CAT_P1_D* CAT_TX_FR_P}]
set_output_delay -clock CAT_FBCLK_P -clock_fall -min -add_delay 4.500 [get_ports {CAT_P1_D* CAT_TX_FR_P}]
...
set_false_path -from [get_clocks -of_objects [get_pins u_gen_clocks_main/inst/mmcm_adv_inst/CLKOUT1]] -to [get_clocks u_antsdr_e310v2_io/BUFR_inst/O]
set_false_path -from [get_clocks clk_200M_o] -to [get_clocks u_antsdr_e310v2_io/BUFR_inst/O]
