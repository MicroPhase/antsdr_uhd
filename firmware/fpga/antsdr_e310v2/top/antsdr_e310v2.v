...
module antsdr_e310v2 (
    ...
    assign pps_ref =    (pps_select == 2'b00)? PPS_IN_INT :
                        (pps_select == 2'b01)? PPS_IN_EXT :
                        (pps_select == 2'b10)? pps_fpga_int: 1'b0;
    ...
    b205_ref_pll #(.DEVICE("AD5660") //valid parameter LTC2640, AD5640, AD5660/2
        )u_b205_ref_pll(
        .reset      ( ~locked      ),
        .clk        ( ref_pll_clk        ),
        .refclk     ( int_40mhz     ),
    ...
    e310v2_ps_bd_wrapper u_e310v2_ps_bd_wrapper(
        .FCLK_CLK0                  ( FCLK_CLK0                  ),
        .FCLK_CLK1                  ( FCLK_CLK1                  ),
        .FCLK_CLK2                  ( FCLK_CLK2                  ),
