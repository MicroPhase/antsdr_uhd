...
set e200_ip_repo_rel_paths [list \
    "ip/deep_fifo" \
    "ip/get_dna" \
]
set ip_repo_paths [list]
foreach rel $e200_ip_repo_rel_paths { lappend ip_repo_paths [file join $root_dir $rel] }
if {[llength $ip_repo_paths] > 0} {
    set_property ip_repo_paths $ip_repo_paths [current_project]
    update_ip_catalog
}
set e200_verilog_defines [list \
    "TARGET_B210=1" \
]
set_property verilog_define $e200_verilog_defines [get_filesets sources_1]

set e200_source_rel_files [list \
...
set e200_constraint_rel_files [list \
    "xdc/e200.xdc" \
]

antsdr_add_rel_files sources_1 $root_dir $e200_source_rel_files
antsdr_add_rel_files constrs_1 $root_dir $e200_constraint_rel_files
set_property top "antsdr_e200" [get_filesets sources_1]
