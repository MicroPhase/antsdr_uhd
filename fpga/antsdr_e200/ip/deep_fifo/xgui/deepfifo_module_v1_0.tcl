...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "log2_fifo_data_width" -parent ${Page_0}
  ipgui::add_param $IPINST -name "log2_fifo_words" -parent ${Page_0}
...
proc update_PARAM_VALUE.log2_fifo_data_width { PARAM_VALUE.log2_fifo_data_width } {
	# Procedure called to update log2_fifo_data_width when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.log2_fifo_data_width { PARAM_VALUE.log2_fifo_data_width } {
	# Procedure called to validate log2_fifo_data_width
	return true
}
...
proc update_MODELPARAM_VALUE.log2_fifo_data_width { MODELPARAM_VALUE.log2_fifo_data_width PARAM_VALUE.log2_fifo_data_width } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.log2_fifo_data_width}] ${MODELPARAM_VALUE.log2_fifo_data_width}
}
